...
g <- g + annotate("text", x = 200, y = 300, label = "y= 1.218x+248.952")
...
```{r CI}
# Calculating beta1 to annotate the graph above
...
This did not turn out expected. Not sure why I can't get the lines to be around the data. The points for log all disappeared
...
pi2
```
I would not trust this model to accurately predict this because it is too far out of bounds 
